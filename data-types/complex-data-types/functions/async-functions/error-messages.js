...
const inputCriteria = {
	...
	zipCode: [ (value) => (value.length === 5 ? '' : 'Zip must be exactly 5 characters long') ],
	state: [ (value) => (value.length === 2 ? '' : 'State must be exactly 2 characters long') ]
};

const getErrorMessages = (inputs, criteria) => {
	return Object.keys(inputs)
		.reduce((acc, fieldName) => [ ...acc, ...criteria[fieldName].map((test) => test(inputs[fieldName])) ], [])

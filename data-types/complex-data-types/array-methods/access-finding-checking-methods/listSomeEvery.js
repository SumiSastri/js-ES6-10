...
const showHighRepairCosts = repairs.every(repairs1KPlus);
// Every checks if every cost is over 1K and returns false as some are under 1K
...
console.log(showHighRepairCosts, 'function call with every method');
